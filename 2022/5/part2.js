...
ordersArray.forEach(order => {
    ...
    for (let i = 0; i < amount; i++) intermediateStack.push(stacksResult1[originStack].pop());
    intermediateStack = intermediateStack.reverse();
    intermediateStack.forEach(item => stacksResult1[targetStack].push(item));
});
